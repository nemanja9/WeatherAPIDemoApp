...
public class DataDay {
    ...
    @JsonProperty("indexto1hvalues_start")
    private List<Integer> indexto1hvaluesStart = null;
    @JsonProperty("indexto1hvalues_end")
    private List<Integer> indexto1hvaluesEnd = null;
    @JsonIgnore
    ...
    @JsonProperty("indexto1hvalues_start")
    public List<Integer> getIndexto1hvaluesStart() {
        return indexto1hvaluesStart;
    }

    @JsonProperty("indexto1hvalues_start")
    public void setIndexto1hvaluesStart(List<Integer> indexto1hvaluesStart) {
        this.indexto1hvaluesStart = indexto1hvaluesStart;
    }

    @JsonProperty("indexto1hvalues_end")
    public List<Integer> getIndexto1hvaluesEnd() {
        return indexto1hvaluesEnd;
    }

    @JsonProperty("indexto1hvalues_end")
    public void setIndexto1hvaluesEnd(List<Integer> indexto1hvaluesEnd) {
